...
REPO_URL="https://github.com/leixiaoyu/lfmt-gemini-poc.git"
PROJECT_DIR="/Users/raymondl/Documents/LFMT POC/lfmt-gemini-poc"
...
if git push -u origin main; then
    ...
    echo "   git remote set-url origin git@github.com:leixiaoyu/lfmt-gemini-poc.git"
    echo "   git push -u origin main"
    echo ""
fi
